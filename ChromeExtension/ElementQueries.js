  ...
  var ElementQueries = function() {
    ...
    function readRules(rules) {
      ...
      if ("string" === typeof rules) {
        ...
        if (
          -1 !== rules.indexOf("min-width") ||
          -1 !== rules.indexOf("max-width")
        ) {
          extractQuery(rules);
        }
      } else {
    ...
    this.init = function() {
      ...
      if (
        ...
        typeof document.documentElement.style["MozAnimationName"] !==
        "undefined"
      ) {
      ...
      document.body.addEventListener(animationStart, function(e) {
        ...
        var requiresSetup =
          animationName && -1 !== animationName.indexOf("element-queries");
